...
// For |cpu$sltiu_rslt.
logic [31:0] CPU_sltiu_rslt_a3;

// For |cpu$sltu_rslt.
logic [31:0] CPU_sltu_rslt_a3;
...
logic [31:0] CPU_Xreg_value_a3 [31:0],
             ...
             CPU_Xreg_value_a10 [31:0];

// For |cpuviz$imm.
logic [31:0] CPUVIZ_imm_a5;

// For |cpuviz$is_add.
logic CPUVIZ_is_add_a5;

// For |cpuviz$is_addi.
logic CPUVIZ_is_addi_a5;

// For |cpuviz$is_and.
logic CPUVIZ_is_and_a5;

// For |cpuviz$is_andi.
logic CPUVIZ_is_andi_a5;

// For |cpuviz$is_auipc.
logic CPUVIZ_is_auipc_a5;

// For |cpuviz$is_beq.
logic CPUVIZ_is_beq_a5;

// For |cpuviz$is_bge.
logic CPUVIZ_is_bge_a5;

// For |cpuviz$is_bgeu.
logic CPUVIZ_is_bgeu_a5;

// For |cpuviz$is_blt.
logic CPUVIZ_is_blt_a5;

// For |cpuviz$is_bltu.
logic CPUVIZ_is_bltu_a5;

// For |cpuviz$is_bne.
logic CPUVIZ_is_bne_a5;

// For |cpuviz$is_csrrc.
logic CPUVIZ_is_csrrc_a5;

// For |cpuviz$is_csrrci.
logic CPUVIZ_is_csrrci_a5;

// For |cpuviz$is_csrrs.
logic CPUVIZ_is_csrrs_a5;

// For |cpuviz$is_csrrsi.
logic CPUVIZ_is_csrrsi_a5;

// For |cpuviz$is_csrrw.
logic CPUVIZ_is_csrrw_a5;

// For |cpuviz$is_csrrwi.
logic CPUVIZ_is_csrrwi_a5;

// For |cpuviz$is_jal.
logic CPUVIZ_is_jal_a5;

// For |cpuviz$is_jalr.
logic CPUVIZ_is_jalr_a5;

// For |cpuviz$is_lb.
logic CPUVIZ_is_lb_a5;

// For |cpuviz$is_lbu.
logic CPUVIZ_is_lbu_a5;

// For |cpuviz$is_lh.
logic CPUVIZ_is_lh_a5;

// For |cpuviz$is_lhu.
logic CPUVIZ_is_lhu_a5;

// For |cpuviz$is_load.
logic CPUVIZ_is_load_a5;

// For |cpuviz$is_lui.
logic CPUVIZ_is_lui_a5;

// For |cpuviz$is_lw.
logic CPUVIZ_is_lw_a5;

// For |cpuviz$is_or.
logic CPUVIZ_is_or_a5;

// For |cpuviz$is_ori.
logic CPUVIZ_is_ori_a5;

// For |cpuviz$is_sb.
logic CPUVIZ_is_sb_a5;

// For |cpuviz$is_sh.
logic CPUVIZ_is_sh_a5;

// For |cpuviz$is_sll.
logic CPUVIZ_is_sll_a5;

// For |cpuviz$is_slli.
logic CPUVIZ_is_slli_a5;

// For |cpuviz$is_slt.
logic CPUVIZ_is_slt_a5;

// For |cpuviz$is_slti.
logic CPUVIZ_is_slti_a5;

// For |cpuviz$is_sltiu.
logic CPUVIZ_is_sltiu_a5;

// For |cpuviz$is_sltu.
logic CPUVIZ_is_sltu_a5;

// For |cpuviz$is_sra.
logic CPUVIZ_is_sra_a5;

// For |cpuviz$is_srai.
logic CPUVIZ_is_srai_a5;

// For |cpuviz$is_srl.
logic CPUVIZ_is_srl_a5;

// For |cpuviz$is_srli.
logic CPUVIZ_is_srli_a5;

// For |cpuviz$is_store.
logic CPUVIZ_is_store_a5;

// For |cpuviz$is_sub.
logic CPUVIZ_is_sub_a5;

// For |cpuviz$is_sw.
logic CPUVIZ_is_sw_a5;

// For |cpuviz$is_xor.
logic CPUVIZ_is_xor_a5;

// For |cpuviz$is_xori.
logic CPUVIZ_is_xori_a5;

// For |cpuviz$mnemonic.
logic [10*8-1:0] CPUVIZ_mnemonic_a5;

// For |cpuviz$pc.
logic [31:0] CPUVIZ_pc_a5;

// For |cpuviz$rd.
logic [4:0] CPUVIZ_rd_a5;

// For |cpuviz$rd_valid.
logic CPUVIZ_rd_valid_a5;

// For |cpuviz$result.
logic [31:0] CPUVIZ_result_a5;

// For |cpuviz$rs1.
logic [4:0] CPUVIZ_rs1_a5;

// For |cpuviz$rs1_valid.
logic CPUVIZ_rs1_valid_a5;

// For |cpuviz$rs2.
logic [4:0] CPUVIZ_rs2_a5;

// For |cpuviz$rs2_valid.
logic CPUVIZ_rs2_valid_a5;

// For |cpuviz$src1_value.
logic [31:0] CPUVIZ_src1_value_a5;

// For |cpuviz$src2_value.
logic [31:0] CPUVIZ_src2_value_a5;

// For |cpuviz$valid.
logic CPUVIZ_valid_a5;
...
// For |cpuviz/defaults$isntr.
logic [24:20] CPUVIZ_Defaults_isntr_a0;
...
// For |cpuviz/defaults$r_isntr.
logic [31:0] CPUVIZ_Defaults_r_isntr_n1,
             CPUVIZ_Defaults_r_isntr_a0;
...
logic clkP_CPU_dmem_rd_en_a5 ;
   ...
   //
      ...
      always_ff @(posedge clk) CPU_imem_rd_addr_a2[4-1:0] <= CPU_imem_rd_addr_a1[4-1:0];
      always_ff @(posedge clk) CPU_imem_rd_addr_a3[4-1:0] <= CPU_imem_rd_addr_a2[4-1:0];
      always_ff @(posedge clk) CPU_imem_rd_addr_a4[4-1:0] <= CPU_imem_rd_addr_a3[4-1:0];
      always_ff @(posedge clk) CPU_imem_rd_addr_a5[4-1:0] <= CPU_imem_rd_addr_a4[4-1:0];
      ...
      always_ff @(posedge clk) CPU_imm_a5[31:0] <= CPU_imm_a4[31:0];
      ...
      always_ff @(posedge clk) CPU_is_add_a5 <= CPU_is_add_a4;
      ...
      always_ff @(posedge clk) CPU_is_addi_a5 <= CPU_is_addi_a4;
      ...
      always_ff @(posedge clk) CPU_is_and_a5 <= CPU_is_and_a4;
      ...
      always_ff @(posedge clk) CPU_is_andi_a5 <= CPU_is_andi_a4;
      ...
      always_ff @(posedge clk) CPU_is_auipc_a5 <= CPU_is_auipc_a4;
      ...
      always_ff @(posedge clk) CPU_is_csrrc_a5 <= CPU_is_csrrc_a4;
      ...
      always_ff @(posedge clk) CPU_is_csrrci_a5 <= CPU_is_csrrci_a4;
      ...
      always_ff @(posedge clk) CPU_is_csrrs_a5 <= CPU_is_csrrs_a4;
      ...
      always_ff @(posedge clk) CPU_is_csrrsi_a5 <= CPU_is_csrrsi_a4;
      ...
      always_ff @(posedge clk) CPU_is_csrrw_a5 <= CPU_is_csrrw_a4;
      ...
      always_ff @(posedge clk) CPU_is_csrrwi_a5 <= CPU_is_csrrwi_a4;
      ...
      always_ff @(posedge clk) CPU_is_jal_a5 <= CPU_is_jal_a4;

      // Staging of $is_jalb.
      always_ff @(posedge clk) CPU_is_jalb_a2 <= CPU_is_jalb_a1;
      always_ff @(posedge clk) CPU_is_jalb_a3 <= CPU_is_jalb_a2;
      always_ff @(posedge clk) CPU_is_jalb_a4 <= CPU_is_jalb_a3;
      always_ff @(posedge clk) CPU_is_jalb_a5 <= CPU_is_jalb_a4;

      // Staging of $is_jalr.
      always_ff @(posedge clk) CPU_is_jalr_a1 <= CPU_is_jalr_a0;
      ...
      always_ff @(posedge clk) CPU_is_jalr_a5 <= CPU_is_jalr_a4;
      ...
      always_ff @(posedge clk) CPU_is_lb_a5 <= CPU_is_lb_a4;
      ...
      always_ff @(posedge clk) CPU_is_lbu_a5 <= CPU_is_lbu_a4;
      ...
      always_ff @(posedge clk) CPU_is_lh_a5 <= CPU_is_lh_a4;
      ...
      always_ff @(posedge clk) CPU_is_lhu_a5 <= CPU_is_lhu_a4;
      ...
      always_ff @(posedge clk) CPU_is_load_a5 <= CPU_is_load_a4;
      ...
      always_ff @(posedge clk) CPU_is_lui_a5 <= CPU_is_lui_a4;
      ...
      always_ff @(posedge clk) CPU_is_lw_a5 <= CPU_is_lw_a4;
      ...
      always_ff @(posedge clk) CPU_is_or_a5 <= CPU_is_or_a4;
      ...
      always_ff @(posedge clk) CPU_is_ori_a5 <= CPU_is_ori_a4;
      ...
      always_ff @(posedge clk) CPU_is_sll_a5 <= CPU_is_sll_a4;
      ...
      always_ff @(posedge clk) CPU_is_slli_a5 <= CPU_is_slli_a4;
      ...
      always_ff @(posedge clk) CPU_is_slt_a5 <= CPU_is_slt_a4;
      ...
      always_ff @(posedge clk) CPU_is_slti_a5 <= CPU_is_slti_a4;
      ...
      always_ff @(posedge clk) CPU_is_sltiu_a5 <= CPU_is_sltiu_a4;
      ...
      always_ff @(posedge clk) CPU_is_sltu_a5 <= CPU_is_sltu_a4;
      ...
      always_ff @(posedge clk) CPU_is_sra_a5 <= CPU_is_sra_a4;

      // Staging of $is_srai.
      always_ff @(posedge clk) CPU_is_srai_a1 <= CPU_is_srai_a0;
      ...
      always_ff @(posedge clk) CPU_is_srai_a5 <= CPU_is_srai_a4;

      // Staging of $is_sral.
      always_ff @(posedge clk) CPU_is_sral_a2 <= CPU_is_sral_a1;
      always_ff @(posedge clk) CPU_is_sral_a3 <= CPU_is_sral_a2;
      always_ff @(posedge clk) CPU_is_sral_a4 <= CPU_is_sral_a3;
      always_ff @(posedge clk) CPU_is_sral_a5 <= CPU_is_sral_a4;
      ...
      always_ff @(posedge clk) CPU_is_srl_a5 <= CPU_is_srl_a4;
      ...
      always_ff @(posedge clk) CPU_is_srli_a5 <= CPU_is_srli_a4;
      ...
      always_ff @(posedge clk) CPU_is_store_a5 <= CPU_is_store_a4;
      ...
      always_ff @(posedge clk) CPU_is_sub_a5 <= CPU_is_sub_a4;
      ...
      always_ff @(posedge clk) CPU_is_xor_a5 <= CPU_is_xor_a4;
      ...
      always_ff @(posedge clk) CPU_is_xori_a5 <= CPU_is_xori_a4;

      // Staging of $isntr.
      always_ff @(posedge clk) CPU_isntr_a1[24:20] <= CPU_isntr_a0[24:20];
      ...
      always_ff @(posedge clk) CPU_pc_a5[31:0] <= CPU_pc_a4[31:0];
      ...
      always_ff @(posedge clk) CPU_rd_a5[4:0] <= CPU_rd_a4[4:0];
      ...
      always_ff @(posedge clk) CPU_rd_valid_a5 <= CPU_rd_valid_a4;
      ...
      always_ff @(posedge clk) CPU_result_a5[31:0] <= CPU_result_a4[31:0];
      ...
      always_ff @(posedge clk) CPU_rs1_valid_a5 <= CPU_rs1_valid_a4;
      ...
      always_ff @(posedge clk) CPU_rs2_valid_a5 <= CPU_rs2_valid_a4;
      ...
      always_ff @(posedge clk) CPU_src1_value_a5[31:0] <= CPU_src1_value_a4[31:0];
      ...
      always_ff @(posedge clk) CPU_src2_value_a5[31:0] <= CPU_src2_value_a4[31:0];
      ...
      always_ff @(posedge clk) CPU_valid_a5 <= CPU_valid_a4;
      ...
      for (dmem = 0; dmem <= 15; dmem++) begin : L1gen_CPU_Dmem
         ...
         always_ff @(posedge clk) L1b_CPU_Dmem[dmem].L1_dummy_a5[0:0] <= L1b_CPU_Dmem[dmem].L1_dummy_a4[0:0];

         // Staging of $value.
         always_ff @(posedge clk) CPU_Dmem_value_a5[dmem][31:0] <= CPU_Dmem_value_a4[dmem][31:0];

         // Staging of $wr.
         always_ff @(posedge clk) L1_CPU_Dmem[dmem].L1_wr_a5 <= L1_CPU_Dmem[dmem].L1_wr_a4;
      ...
      for (xreg = 0; xreg <= 31; xreg++) begin : L1gen_CPU_Xreg
         ...
         always_ff @(posedge clk) L1b_CPU_Xreg[xreg].L1_dummy_a5[0:0] <= L1b_CPU_Xreg[xreg].L1_dummy_a4[0:0];
         ...
         always_ff @(posedge clk) CPU_Xreg_value_a7[xreg][31:0] <= CPU_Xreg_value_a6[xreg][31:0];
         always_ff @(posedge clk) CPU_Xreg_value_a8[xreg][31:0] <= CPU_Xreg_value_a7[xreg][31:0];
         always_ff @(posedge clk) CPU_Xreg_value_a9[xreg][31:0] <= CPU_Xreg_value_a8[xreg][31:0];
         always_ff @(posedge clk) CPU_Xreg_value_a10[xreg][31:0] <= CPU_Xreg_value_a9[xreg][31:0];

         // Staging of $wr.
         always_ff @(posedge clk) L1_CPU_Xreg[xreg].L1_wr_a4 <= L1_CPU_Xreg[xreg].L1_wr_a3;
         always_ff @(posedge clk) L1_CPU_Xreg[xreg].L1_wr_a5 <= L1_CPU_Xreg[xreg].L1_wr_a4;
   ...
   //
      ...
      //
         ...
         // Staging of signal $isntr, which had no assignment.
         // Assign to a random value.
         // verilator lint_save
         // verilator lint_off WIDTH
         assign CPUVIZ_Defaults_isntr_a0[24:20] = CPUVIZ_Defaults_r_isntr_a0;
         // verilator lint_restore

         // Staging of random value for missing assignment.
         assign CPUVIZ_Defaults_r_isntr_n1[31:0] = $random() ^ {31'b0, clk};
         always_ff @(posedge clk) CPUVIZ_Defaults_r_isntr_a0[31:0] <= CPUVIZ_Defaults_r_isntr_n1[31:0];
      ...
      for (dmem = 0; dmem <= 15; dmem++) begin : L1gen_CPUVIZ_Dmem
         // Staging of $value.
         always_ff @(posedge clk) L1_CPUVIZ_Dmem[dmem].L1_value_a6[31:0] <= L1_CPUVIZ_Dmem[dmem].L1_value_a5[31:0];
      ...
      for (xreg = 0; xreg <= 31; xreg++) begin : L1gen_CPUVIZ_Xreg
         // Staging of $value.
         always_ff @(posedge clk) L1_CPUVIZ_Xreg[xreg].L1_value_a6[31:0] <= L1_CPUVIZ_Xreg[xreg].L1_value_a5[31:0];
...
//
   ...
   if (1) begin : DEBUG_SIGS
      ...
      if (1) begin : \|cpu 
         ...
         logic  \/@1$is_jalb ;
         assign \/@1$is_jalb = CPU_is_jalb_a1;
         logic  \/@0$is_jalr ;
         assign \/@0$is_jalr = CPU_is_jalr_a0;
         logic  \/@3$is_jump ;
         assign \/@3$is_jump = CPU_is_jump_a3;
         logic  \/@0$is_lb ;
         assign \/@0$is_lb = CPU_is_lb_a0;
         logic  \/@0$is_lbu ;
         assign \/@0$is_lbu = CPU_is_lbu_a0;
         logic  \/@0$is_lh ;
         assign \/@0$is_lh = CPU_is_lh_a0;
         logic  \/@0$is_lhu ;
         assign \/@0$is_lhu = CPU_is_lhu_a0;
         logic  \/@1$is_load ;
         assign \/@1$is_load = CPU_is_load_a1;
         logic  \/@1$is_lui ;
         assign \/@1$is_lui = CPU_is_lui_a1;
         logic  \/@0$is_lw ;
         assign \/@0$is_lw = CPU_is_lw_a0;
         logic  \/@1$is_or ;
         ...
         logic  \/@0$is_srai ;
         assign \/@0$is_srai = CPU_is_srai_a0;
         logic  \/@1$is_sral ;
         assign \/@1$is_sral = CPU_is_sral_a1;
         logic  \/@1$is_srl ;
      ...
      if (1) begin : \|cpuviz 
         logic [31:0] \/@5$imm ;
         assign \/@5$imm = CPUVIZ_imm_a5;
         logic  \/@5$is_add ;
         assign \/@5$is_add = CPUVIZ_is_add_a5;
         logic  \/@5$is_addi ;
         assign \/@5$is_addi = CPUVIZ_is_addi_a5;
         logic  \/@5$is_and ;
         assign \/@5$is_and = CPUVIZ_is_and_a5;
         logic  \/@5$is_andi ;
         assign \/@5$is_andi = CPUVIZ_is_andi_a5;
         logic  \/@5$is_auipc ;
         assign \/@5$is_auipc = CPUVIZ_is_auipc_a5;
         logic  \/@5$is_beq ;
         assign \/@5$is_beq = CPUVIZ_is_beq_a5;
         logic  \/@5$is_bge ;
         assign \/@5$is_bge = CPUVIZ_is_bge_a5;
         logic  \/@5$is_bgeu ;
         assign \/@5$is_bgeu = CPUVIZ_is_bgeu_a5;
         logic  \/@5$is_blt ;
         assign \/@5$is_blt = CPUVIZ_is_blt_a5;
         logic  \/@5$is_bltu ;
         assign \/@5$is_bltu = CPUVIZ_is_bltu_a5;
         logic  \/@5$is_bne ;
         assign \/@5$is_bne = CPUVIZ_is_bne_a5;
         logic  \/@5$is_csrrc ;
         assign \/@5$is_csrrc = CPUVIZ_is_csrrc_a5;
         logic  \/@5$is_csrrci ;
         assign \/@5$is_csrrci = CPUVIZ_is_csrrci_a5;
         logic  \/@5$is_csrrs ;
         assign \/@5$is_csrrs = CPUVIZ_is_csrrs_a5;
         logic  \/@5$is_csrrsi ;
         assign \/@5$is_csrrsi = CPUVIZ_is_csrrsi_a5;
         logic  \/@5$is_csrrw ;
         assign \/@5$is_csrrw = CPUVIZ_is_csrrw_a5;
         logic  \/@5$is_csrrwi ;
         assign \/@5$is_csrrwi = CPUVIZ_is_csrrwi_a5;
         logic  \/@5$is_jal ;
         assign \/@5$is_jal = CPUVIZ_is_jal_a5;
         logic  \/@5$is_jalr ;
         assign \/@5$is_jalr = CPUVIZ_is_jalr_a5;
         logic  \/@5$is_lb ;
         assign \/@5$is_lb = CPUVIZ_is_lb_a5;
         logic  \/@5$is_lbu ;
         assign \/@5$is_lbu = CPUVIZ_is_lbu_a5;
         logic  \/@5$is_lh ;
         assign \/@5$is_lh = CPUVIZ_is_lh_a5;
         logic  \/@5$is_lhu ;
         assign \/@5$is_lhu = CPUVIZ_is_lhu_a5;
         logic  \/@5$is_load ;
         assign \/@5$is_load = CPUVIZ_is_load_a5;
         logic  \/@5$is_lui ;
         assign \/@5$is_lui = CPUVIZ_is_lui_a5;
         logic  \/@5$is_lw ;
         assign \/@5$is_lw = CPUVIZ_is_lw_a5;
         logic  \/@5$is_or ;
         assign \/@5$is_or = CPUVIZ_is_or_a5;
         logic  \/@5$is_ori ;
         assign \/@5$is_ori = CPUVIZ_is_ori_a5;
         logic  \/@5$is_sb ;
         assign \/@5$is_sb = CPUVIZ_is_sb_a5;
         logic  \/@5$is_sh ;
         assign \/@5$is_sh = CPUVIZ_is_sh_a5;
         logic  \/@5$is_sll ;
         assign \/@5$is_sll = CPUVIZ_is_sll_a5;
         logic  \/@5$is_slli ;
         assign \/@5$is_slli = CPUVIZ_is_slli_a5;
         logic  \/@5$is_slt ;
         assign \/@5$is_slt = CPUVIZ_is_slt_a5;
         logic  \/@5$is_slti ;
         assign \/@5$is_slti = CPUVIZ_is_slti_a5;
         logic  \/@5$is_sltiu ;
         assign \/@5$is_sltiu = CPUVIZ_is_sltiu_a5;
         logic  \/@5$is_sltu ;
         assign \/@5$is_sltu = CPUVIZ_is_sltu_a5;
         logic  \/@5$is_sra ;
         assign \/@5$is_sra = CPUVIZ_is_sra_a5;
         logic  \/@5$is_srai ;
         assign \/@5$is_srai = CPUVIZ_is_srai_a5;
         logic  \/@5$is_srl ;
         assign \/@5$is_srl = CPUVIZ_is_srl_a5;
         logic  \/@5$is_srli ;
         assign \/@5$is_srli = CPUVIZ_is_srli_a5;
         logic  \/@5$is_store ;
         assign \/@5$is_store = CPUVIZ_is_store_a5;
         logic  \/@5$is_sub ;
         assign \/@5$is_sub = CPUVIZ_is_sub_a5;
         logic  \/@5$is_sw ;
         assign \/@5$is_sw = CPUVIZ_is_sw_a5;
         logic  \/@5$is_xor ;
         assign \/@5$is_xor = CPUVIZ_is_xor_a5;
         logic  \/@5$is_xori ;
         assign \/@5$is_xori = CPUVIZ_is_xori_a5;
         logic [10*8-1:0] \/@5$mnemonic ;
         assign \/@5$mnemonic = CPUVIZ_mnemonic_a5;
         logic [31:0] \/@5$pc ;
         assign \/@5$pc = CPUVIZ_pc_a5;
         logic [4:0] \/@5$rd ;
         assign \/@5$rd = CPUVIZ_rd_a5;
         logic  \/@5$rd_valid ;
         assign \/@5$rd_valid = CPUVIZ_rd_valid_a5;
         logic [31:0] \/@5$result ;
         assign \/@5$result = CPUVIZ_result_a5;
         logic [4:0] \/@5$rs1 ;
         assign \/@5$rs1 = CPUVIZ_rs1_a5;
         logic  \/@5$rs1_valid ;
         assign \/@5$rs1_valid = CPUVIZ_rs1_valid_a5;
         logic [4:0] \/@5$rs2 ;
         assign \/@5$rs2 = CPUVIZ_rs2_a5;
         logic  \/@5$rs2_valid ;
         assign \/@5$rs2_valid = CPUVIZ_rs2_valid_a5;
         logic [31:0] \/@5$src1_value ;
         assign \/@5$src1_value = CPUVIZ_src1_value_a5;
         logic [31:0] \/@5$src2_value ;
         assign \/@5$src2_value = CPUVIZ_src2_value_a5;
         logic  \/@5$valid ;
         assign \/@5$valid = CPUVIZ_valid_a5;
         ...
         if (1) begin : \/defaults 
            ...
            logic [24:20] \>>@0$isntr ;
            assign \>>@0$isntr = CPUVIZ_Defaults_isntr_a0;
         ...
         for (dmem = 0; dmem <= 15; dmem++) begin : \/dmem 
            logic [0:0] \//@5$dummy ;
            assign \//@5$dummy = L1_CPUVIZ_Dmem[dmem].L1_dummy_a5;
            logic [31:0] \//@5$value ;
            assign \//@5$value = L1_CPUVIZ_Dmem[dmem].L1_value_a5;
            logic  \//@5$wr ;
            assign \//@5$wr = L1_CPUVIZ_Dmem[dmem].L1_wr_a5;
         end
         ...
         for (xreg = 0; xreg <= 31; xreg++) begin : \/xreg 
            logic [0:0] \//@5$dummy ;
            assign \//@5$dummy = L1_CPUVIZ_Xreg[xreg].L1_dummy_a5;
            logic [31:0] \//@5$value ;
            assign \//@5$value = L1_CPUVIZ_Xreg[xreg].L1_value_a5;
            logic  \//@5$wr ;
            assign \//@5$wr = L1_CPUVIZ_Xreg[xreg].L1_wr_a5;
         end
      end
