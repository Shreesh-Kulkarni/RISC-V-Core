...
`include "top_gen.sv" //_\TLV
   ...
   //_|cpu
      //_@0
         ...
         assign CPU_pc_a0[31:0] = CPU_reset_a1? 0 :
                     ...
                     CPU_valid_load_a3 ? CPU_pc_a3[31:0] + 32'd4:
                     CPU_pc_a1[31:0] + 32'd4;
      ...
      //_@1
         ...
         assign CPU_rs2_a1[4:0] = CPU_isntr_a1[24:20];
         ...
         assign CPU_is_sral_a1   = CPU_dec_bits_a1 ==? 11'b1_101_0010011;
         ...
         assign CPU_is_jalb_a1   = CPU_dec_bits_a1 ==? 11'bx_000_1100111;
      ...
      //_@2
         ...
         assign CPU_src1_value_a2[31:0] = (CPU_rf_wr_en_a3 && (CPU_rd_a3[4:0] == CPU_rs1_a2[4:0]))? CPU_result_a3[31:0]: CPU_rf_rd_data1_a2[31:0];
         assign CPU_src2_value_a2[31:0] = (CPU_rf_wr_en_a3 && (CPU_rd_a3[4:0] == CPU_rs2_a2[4:0]))? CPU_result_a3[31:0]: CPU_rf_rd_data2_a2[31:0];
      ...
      //_@3
         ...
         assign CPU_valid_a3 = !(CPU_valid_taken_br_a4 || CPU_valid_taken_br_a5|| CPU_valid_load_a4 || CPU_valid_load_a5 || CPU_valid_jump_a3);
      ...
      //_@4
         ...
         assign CPU_dmem_rd_en_a4 = CPU_is_load_a4 && CPU_valid_a4;
   ...
   //  o CPU visualization
   //_|cpu
      `line 20 "/raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv" 1   // Instantiated from top.tlv, 263 as: m4+imem(@1)
      ...
      `line 264 "top.tlv" 2
      `line 75 "/raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv" 1   // Instantiated from top.tlv, 264 as: m4+rf(@2, @3)
         // Reg File
         //_@3
      ...
      `line 265 "top.tlv" 2
      `line 92 "/raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv" 1   // Instantiated from top.tlv, 265 as: m4+dmem(@4)
         // Data Memory
         //_@4
   ...
   `line 145 "/raw.githubusercontent.com/BalaDhinesh/RISCVMYTHWorkshop/master/tlvlib/riscvshelllib.tlv" 1   // Instantiated from top.tlv, 268 as: m4+cpu_viz(@5)
      ...
      //_|cpu
         ...
         //_@0
            assign {CPU_dummy_a0[0:0], CPU_is_csrrc_a0, CPU_is_csrrci_a0, CPU_is_csrrs_a0, CPU_is_csrrsi_a0, CPU_is_csrrw_a0, CPU_is_csrrwi_a0, CPU_is_jalr_a0, CPU_is_lb_a0, CPU_is_lbu_a0, CPU_is_lh_a0, CPU_is_lhu_a0, CPU_is_lw_a0, CPU_is_srai_a0, CPU_is_store_a0, CPU_isntr_a0[24:20]} = {CPUVIZ_Defaults_dummy_a0, CPUVIZ_Defaults_is_csrrc_a0, CPUVIZ_Defaults_is_csrrci_a0, CPUVIZ_Defaults_is_csrrs_a0, CPUVIZ_Defaults_is_csrrsi_a0, CPUVIZ_Defaults_is_csrrw_a0, CPUVIZ_Defaults_is_csrrwi_a0, CPUVIZ_Defaults_is_jalr_a0, CPUVIZ_Defaults_is_lb_a0, CPUVIZ_Defaults_is_lbu_a0, CPUVIZ_Defaults_is_lh_a0, CPUVIZ_Defaults_is_lhu_a0, CPUVIZ_Defaults_is_lw_a0, CPUVIZ_Defaults_is_srai_a0, CPUVIZ_Defaults_is_store_a0, CPUVIZ_Defaults_isntr_a0};
