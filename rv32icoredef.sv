...
logic clkP_CPU_rs2_valid_a5 ;
   ...
   //
      ...
      always_ff @(posedge clk) CPU_jalr_tgt_pc_a3 <= CPU_jalr_tgt_pc_a2;
      ...
      always_ff @(posedge clkP_CPU_rs1_valid_a5) CPU_rs1_a5[4:0] <= CPU_rs1_a4[4:0];
      ...
      always_ff @(posedge clkP_CPU_rs2_valid_a5) CPU_rs2_a5[4:0] <= CPU_rs2_a4[4:0];
...
//
   ...
   //
      ...
      clk_gate gen_clkP_CPU_rs1_valid_a5(clkP_CPU_rs1_valid_a5, clk, 1'b1, CPU_rs1_valid_a4, 1'b0);
      ...
      clk_gate gen_clkP_CPU_rs2_valid_a5(clkP_CPU_rs2_valid_a5, clk, 1'b1, CPU_rs2_valid_a4, 1'b0);
...
//
   ...
   if (1) begin : DEBUG_SIGS
      ...
      if (1) begin : \|cpu 
         ...
         logic  \/@2$is_jalb ;
         assign \/@2$is_jalb = CPU_is_jalb_a2;
         logic  \/@0$is_jalr ;
         assign \/@0$is_jalr = CPU_is_jalr_a0;
         logic  \/@3$is_jump ;
         assign \/@3$is_jump = CPU_is_jump_a3;
         logic  \/@2$is_lb ;
         assign \/@2$is_lb = CPU_is_lb_a2;
         logic  \/@2$is_lbu ;
         assign \/@2$is_lbu = CPU_is_lbu_a2;
         logic  \/@2$is_lh ;
         assign \/@2$is_lh = CPU_is_lh_a2;
         logic  \/@2$is_lhu ;
         assign \/@2$is_lhu = CPU_is_lhu_a2;
         logic  \/@2$is_load ;
         assign \/@2$is_load = CPU_is_load_a2;
         logic  \/@2$is_lui ;
         assign \/@2$is_lui = CPU_is_lui_a2;
         logic  \/@2$is_lw ;
         assign \/@2$is_lw = CPU_is_lw_a2;
         logic  \/@2$is_or ;
         ...
         logic  \/@2$is_sral ;
         assign \/@2$is_sral = CPU_is_sral_a2;
         logic  \/@2$is_srl ;
